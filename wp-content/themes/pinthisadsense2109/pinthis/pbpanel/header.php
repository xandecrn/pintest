<div class="pbpanel-container">
	<div class="pbpanel-column pbpanel-column-sticky">
		<div class="pbpanel-box">
			<div class="pbpanel-logo"><a onclick="window.open('https://pixelbeautify.com');return false;" href="https://pixelbeautify.com"><img src="<?php echo get_template_directory_uri(); ?>/pbpanel/images/logo.png" alt="<?php echo __('PB Panel', 'pbpanel'); ?>" /></a></div>
			<nav class="pbpanel-navigation">
				<ul>
					...
					<li><a href="<?php echo admin_url('admin.php?page=pbpanel-googleads'); ?>" class="pbpanel-icon-nav-7 <?php if ($_REQUEST['page'] == 'pbpanel-googleads'): echo 'active'; endif; ?>"><?php echo __('Google Adsense', 'pbpanel'); ?></a></li>
