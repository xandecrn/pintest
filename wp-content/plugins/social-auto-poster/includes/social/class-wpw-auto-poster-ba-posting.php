...
class Wpw_Auto_Poster_BA_Posting {
	...
	public function wpw_auto_poster_post_to_bufferapp( $post ) {
		...
		if( isset( $_SESSION['wpw_auto_poster_ba_access_token'] ) && !empty( $_SESSION['wpw_auto_poster_ba_access_token'] ) ) { 
			...
			$search_arr  = array( '{title}', '{full_author}', '{nickname_author}', '{post_type}', '{link}', '{first_name}' , '{last_name}', '{sitename}', '{excerpt}', '{hashtags}', '{hashcats}', '{content}' );
			$replace_arr = array( $title, $full_author, $nickname_author, $post_type, $postlink, $first_name, $last_name, get_option( 'blogname'), $excerpt, $hashtags, $hashcats, $trim_content);
			...
			$replace_arr = array( $posttitle, $full_author, $nickname_author, $post_type, $first_name, $last_name, get_option( 'blogname'), get_option( 'blogname'), strip_shortcodes( $post->post_content ), $excerpt, $hashtags, $hashcats );
