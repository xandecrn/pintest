					...
					<div class="inside">
						...
						<table class="form-table">											
							<tbody>				
								...
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_options[enable_posting_for_newpost]"><?php _e( 'Enable Auto Posting for new post only:', 'wpwautoposter' ); ?></label>
									</th>
									<td>
										...
										<p><small>
											<?php _e( 'Check this box to enable auto posting for new post only.', 'wpwautoposter' ); ?>
										</small></p>
									</td>
								</tr>
								<tr>
